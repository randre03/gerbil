...
(begin
  ...
  (define |gerbil/core$<sugar>$<sugar:1>[1]#_g42808_|
    (##structure
     gx#syntax-quote::t
     'else
     #f
                                      ...
                                      (let ((_e37414125_
                                        ...
                                        (let ((_tl37394132_
                                          ...
                                          (if (gx#identifier? _hd37404129_)
                                              (if (gx#free-identifier=?
                                                   |gerbil/core$<sugar>$<sugar:1>[1]#_g42808_|
                                                   _hd37404129_)
                                                  (if (gx#stx-pair/null?
                                                       _tl37394132_)
                                      ...
                                      (let ((_g42809_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target42344275_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42809_ 0)))
                                                (_tl42364278_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42809_ 1))))
                                      ...
                                      (let ((_g42811_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target43524393_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42811_ 0)))
                                                (_tl43544396_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42811_ 1))))
                                      ...
                                      (let ((_g42813_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target44694510_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42813_ 0)))
                                                (_tl44714513_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42813_ 1))))
