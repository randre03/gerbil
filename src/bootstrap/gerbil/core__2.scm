...
(begin
  (define |gerbil/core$<syntax-sugar>[1]#_g42794_|
    (##structure
     gx#syntax-quote::t
     'values
     #f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                          (not safe))
                        (##fx= _g42793_ 2)))
                 (error "Context expects 2 values" _g42793_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                                   (let ((_target297318_
                                                          (let ()
                                                            (declare
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<syntax-sugar>[:0:]#with-syntax|
      (lambda (_stx380_)
        (let* ((___stx3713137132_ _stx380_)
               (_g385470_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                                ...
                                (lambda (_hd395790_ _body401793_)
                                  (if (gx#stx-pair? _hd395790_)
                                      ...
                                      (let ((_body402806_
                                        ...
                                        (___kont3713437135_ _body402806_))))))
                        (_loop397786_ _target394780_ '())))))
              (if (gx#stx-pair? ___stx3713137132_)
                  (let ((_e390760_ (gx#syntax-e ___stx3713137132_)))
                    (let ((_tl388767_
                      ...
                      (if (gx#stx-pair/null? _hd392774_)
                          (let ((___splice3714437145_
                            ...
                            (let ((_tl441500_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref ___splice3714437145_ '1)))
                                  (_target439497_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref ___splice3714437145_ '0))))
                              (if (gx#stx-null? _tl441500_)
                                  (___match3723237233_
                                   _e390760_
                                   _hd389764_
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<syntax-sugar>[:0:]#with-syntax*|
      (lambda (_stx843_)
        (let* ((___stx3723537236_ _stx843_)
               (_g848925_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                                ...
                                (lambda (_hd8581201_ _body8641204_)
                                  (if (gx#stx-pair? _hd8581201_)
                                      ...
                                      (let ((_body8651217_
                                        ...
                                        (___kont3723837239_ _body8651217_))))))
                        (_loop8601197_ _target8571191_ '())))))
              (if (gx#stx-pair? ___stx3723537236_)
                  (let ((_e8531171_ (gx#syntax-e ___stx3723537236_)))
                    (let ((_tl8511178_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                  ...
                  (if (gx#identifier? _hd8841077_)
                      (if (gx#free-identifier=?
                           |gerbil/core$<syntax-sugar>[1]#_g42794_|
                           _hd8841077_)
                      ...
                      (if (gx#stx-pair/null? _tl8541188_)
                          (let ((___splice3724837249_
                            ...
                            (let ((_tl913965_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref ___splice3724837249_ '1)))
                                  (_target911962_
                                   (let ()
                                     (declare (not safe))
                                     (##vector-ref ___splice3724837249_ '0))))
                              (if (gx#stx-null? _tl913965_)
                                  (___match3734837349_
                                   _e8531171_
                                   _hd8521175_
