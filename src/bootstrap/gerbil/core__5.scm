...
(begin
  (define |gerbil/core$<sugar>$<sugar:3>[1]#_g42903_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
  ...
  (begin
    (define |gerbil/core$<sugar>$<sugar:3>[:0:]#defsyntax|
      (lambda (_$stx16997_)
        (let* ((___stx3957739578_ _$stx16997_)
               (_g1700217041_
                (lambda ()
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
            ...
            (let* ((___match3963239633_
                    (lambda (_e1702917048_
                      ...
                      (let ((_L17078_ _hd1703417072_)
                        ...
                        (if (gx#identifier? _L17080_)
                            (___kont3958439585_ _L17078_ _L17080_)
              ...
              (if (gx#stx-pair? ___stx3957739578_)
                  (let ((_e1700917104_ (gx#syntax-e ___stx3957739578_)))
                    (let ((_tl1700717111_
      ...
      (lambda (_stx17200_)
        (let* ((_g1720317240_
                (lambda (_g1720417236_)
                  (gx#raise-syntax-error '#f '"Bad syntax" _g1720417236_)))
               (_g1720217601_
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g42898_ 2)))
                (error "Context expects 2 values" _g42898_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                        ...
                        (begin
                          (let ((_g42902_
                                 (let ()
                                   (declare (not safe))
                                   (if (##values? _g42901_)
                                       (##vector-length _g42901_)
                                       1))))
                            (if (not (let ()
                                       (declare (not safe))
                                       (##fx= _g42902_ 2)))
                                (error "Context expects 2 values" _g42902_)))
                          (let ((_target1740317424_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g42901_ 0)))
                                (_tl1740517427_
                                 (let ()
                                   (declare (not safe))
                                   (##vector-ref _g42901_ 1))))
...
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
    ...
    (define |gerbil/core$<sugar>$<sugar:3>[:0:]#defconst|
      (lambda (_$stx17608_)
        (let* ((___stx3963539636_ _$stx17608_)
               (_g1761317649_
                (lambda ()
                  (gx#raise-syntax-error
                   '#f
                    ...
                    (lambda (_e1763717656_
                      ...
                      (let ((_L17686_ _hd1764217680_)
                        ...
                        (if (and (gx#identifier? _L17688_)
                            ...
                            (___kont3964039641_ _L17686_ _L17688_ _L17689_)
                    ...
                    (lambda (_e1761917713_
                      ...
                      (let ((_L17763_ _hd1763017757_)
                        ...
                        (if (gx#identifier? _L17765_)
                            (___kont3963839639_ _L17763_ _L17765_)
                            (___match3970039701_
                             _e1761917713_
                             _hd1761817717_
                             _tl1761717720_
                             ...
                             _hd1762417737_
                             _tl1762317740_))))))
              (if (gx#stx-pair? ___stx3963539636_)
                  (let ((_e1761917713_ (gx#syntax-e ___stx3963539636_)))
                    (let ((_tl1761717720_
                                            ...
                                            (let ((_tl1762617750_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:3>[1]#_g42903_|
                                                       _hd1762717747_)
                                                      (if (gx#stx-pair?
                                                           _tl1762617750_)
                                                          (let ((_e1763117753_
