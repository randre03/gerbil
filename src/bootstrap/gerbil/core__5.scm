...
(begin
  (define |gerbil/core$<sugar>$<sugar:3>[1]#_g42873_|
    (##structure
     gx#syntax-quote::t
     'quote
     #f
...
;;<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
                         (not safe))
                       (##fx= _g42868_ 2)))
                (error "Context expects 2 values" _g42868_)))
;;>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
                                      ...
                                      (let ((_g42869_
                                        ...
                                        (begin
                                          ...
                                          (let ((_target1722617307_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42869_ 0)))
                                                (_tl1722817310_
                                                 (let ()
                                                   (declare (not safe))
                                                   (##vector-ref _g42869_ 1))))
                        ...
                        (begin
                          (let ((_g42872_
                            ...
                            (if (not (let ()
                                       (declare (not safe))
                                       (##fx= _g42872_ 2)))
                                (error "Context expects 2 values" _g42872_)))
                                            ...
                                            (let ((_tl1762617750_
                                              ...
                                              (if (gx#identifier?
                                                  ...
                                                  (if (gx#free-identifier=?
                                                       |gerbil/core$<sugar>$<sugar:3>[1]#_g42873_|
                                                       _hd1762717747_)
                                                      (if (gx#stx-pair?
                                                           _tl1762617750_)
                                                          (let ((_e1763117753_
